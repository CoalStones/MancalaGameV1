...
public class AISolution {
    ...
    private int getPlayerMove(int[] board, boolean playerTurn) {
    ...
    private void distributeStones(int[] board, int move, boolean playerTurn) {
    ...
    private void captureStones(int[] board, int currentIndex, boolean playerTurn) {
    ...
    private void determineWinner(int[] board) {
